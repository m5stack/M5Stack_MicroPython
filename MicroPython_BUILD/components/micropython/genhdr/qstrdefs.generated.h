...
QDEF(MP_QSTR_MODE_I2S, (const byte*)"\x71\xf3\x08" "MODE_I2S")
QDEF(MP_QSTR_MODE_IN_DAC, (const byte*)"\x87\x5f\x0b" "MODE_IN_DAC")
...
QDEF(MP_QSTR_bclk, (const byte*)"\x43\x2c\x04" "bclk")
...
QDEF(MP_QSTR_data_in, (const byte*)"\xcd\xc4\x07" "data_in")
QDEF(MP_QSTR_data_len, (const byte*)"\xad\x71\x08" "data_len")
QDEF(MP_QSTR_data_out, (const byte*)"\xe4\x56\x08" "data_out")
...
QDEF(MP_QSTR_stream_out, (const byte*)"\x28\x50\x0a" "stream_out")
